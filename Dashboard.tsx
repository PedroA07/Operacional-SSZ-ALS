  ...
  return (
    <div className="flex h-screen bg-[#f8fafc] overflow-hidden font-sans text-slate-900">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-14 bg-white border-b border-slate-200/80 flex items-center justify-between px-6 z-40 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
          <div className="flex items-center gap-3">
            ...
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path d="M4 6h16M4 12h16m-7 6h7" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
            ...
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-[11px] font-black text-slate-700 uppercase tracking-widest">{activeTab}</h2>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button
        ...
        <div id="dashboard-scroll" className="flex-1 overflow-y-auto overflow-x-hidden p-8 bg-[#f1f5f9] custom-scrollbar">
         ...
         <Suspense fallback={<TabFallback />}>
           ...
           {activeTab === DashboardTab.PORTOS && <PortsTab userId={user.id} user={user} ports={ports} onSavePort={async (p, id) => {

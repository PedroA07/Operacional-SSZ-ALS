...
const TripsYesterday: React.FC<TripsYesterdayProps> = ({ trips }) => {
  ...
  const clientStats = useMemo(() => statsCalculator.calculateFullDashboardStats(yesterdayRaw, 'client'), [yesterdayRaw]);
  const driverStats = useMemo(() => statsCalculator.calculateFullDashboardStats(yesterdayRaw, 'driver'), [yesterdayRaw]);
  ...
  }, [yesterdayRaw, selClients, selDrivers]);

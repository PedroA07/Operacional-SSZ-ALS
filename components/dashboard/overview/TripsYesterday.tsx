...
const TripsYesterday: React.FC<TripsYesterdayProps> = ({ trips }) => {
  ...
  return (
    <div className="relative" style={{ zIndex: isOpen ? 500 : 10 }}>
      ...
      {isOpen && (
        <div className="absolute top-[calc(100%-1px)] left-0 right-0 bg-white border border-slate-800 rounded-b-[2.5rem] shadow-2xl z-[160] animate-in slide-in-from-top-1 duration-300 max-h-[600px] flex flex-col">

...
export const EquipmentColumn = (t: Trip) => (
  <div className="flex flex-col space-y-1 whitespace-normal min-w-[180px]">
    ...
    <div className="grid grid-cols-1 gap-0.5">
      ...
      <div className="flex items-center gap-2">
        <span className="text-[9px] font-black text-slate-400 uppercase">Tara:</span>
        <span className="text-[10px] font-bold text-slate-600">{t.tara || '---'}</span>
      </div>
      
      <div className="flex items-center gap-2">
        <span className="text-[9px] font-black text-slate-400 uppercase">Lacre:</span>
        <span className="text-[10px] font-bold text-slate-600">{t.seal || '---'}</span>
      </div>

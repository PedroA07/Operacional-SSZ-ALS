      ...
      <div className="bg-white w-full max-w-6xl h-[90vh] rounded-[3rem] shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95">
        ...
        <div className="flex-1 overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="flex-1 bg-slate-800 p-8 flex flex-col overflow-hidden relative">
             {selectedDoc ? (
               <>
                 <div className="flex-1 bg-black/40 rounded-[2.5rem] overflow-hidden relative border border-white/5 shadow-2xl">
                    <ImageViewer url={selectedDoc.url} />
                    
                    <button 
                      onClick={() => downloadImage(selectedDoc.url, selectedDoc.id)}
                      className="absolute top-6 right-6 p-4 bg-white/10 hover:bg-blue-600 text-white rounded-2xl backdrop-blur-md border border-white/10 shadow-2xl transition-all active:scale-90 z-20"
                      title="Baixar Foto"
                    >
                    ...
                    {isProcessing === selectedDoc.id && (
                      <div className="absolute inset-0 bg-slate-900/80 backdrop-blur-sm flex flex-col items-center justify-center text-white space-y-4 z-50">
               ...
               <div className="flex-1 flex flex-col items-center justify-center text-slate-600 space-y-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[10px] font-bold text-slate-600 uppercase mt-2">Para processar chaves ou analisar detalhes</p>
                  </div>
               </div>
             )}
          </div>

...
export const getOperationTableColumns = (
  ...
  actingUser: User,
  onLocateDriver: (driverId: string) => void // Novo callback para localizar motorista
) => {

            ...
            <tbody className="divide-y divide-slate-100">
              {filtered.map(p => (
                <tr key={p.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 font-mono font-bold text-slate-500">{maskCNPJ(p.cnpj)}</td>
                  ...
                  <td className="px-6 py-4 font-mono font-bold text-slate-500">{maskCEP(p.zipCode || '')}</td>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <select required className={inputClasses} value={form.state} onChange={e => setForm({...form, state: e.target.value.toUpperCase()})}>

...
import { User, MessageTemplate, Customer, Port, PreStacking } from '../../../types';
...
const MessageComposerModal: React.FC<MessageComposerModalProps> = ({ isOpen, onClose, onSuccess, template, user }) => {

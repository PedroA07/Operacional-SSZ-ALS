        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '3px solid #1e40af', paddingBottom: '20px', marginBottom: '30px' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <div style={{ width: '60px', height: '60px', marginRight: '8px', overflow: 'hidden', borderRadius: '10px' }}>
          ...
          <div style={{ display: 'flex', gap: '30px', marginBottom: '30px' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '15px' }}>
               ...
               <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                  ...
                  {driver.cnhPdfUrl && (
                     <div style={{ backgroundColor: '#ecfdf5', padding: '6px 12px', borderRadius: '8px', border: '1.5px solid #10b981', display: 'flex', alignItems: 'center', gap: '8px' }}>

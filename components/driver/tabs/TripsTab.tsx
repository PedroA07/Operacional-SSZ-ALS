  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
       <div className="flex justify-between items-center px-1">
          ...
          <p className="text-[8px] font-bold text-blue-400 uppercase tracking-widest">Tempo Real</p>
       </div>
       ...
       <div className="space-y-4">
          {trips.length > 0 ? trips.map((t, idx) => {
            ...
            <div className="py-20 text-center text-slate-600 font-black uppercase text-[10px]">Nenhuma viagem vinculada ao seu CPF.</div>
          )}
       </div>
    </div>
  );

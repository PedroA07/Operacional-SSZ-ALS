  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
       <div className="text-center py-6">
          ...
          <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest mt-1">Arquivos das suas operações</p>
       </div>
       ...
       <div className="space-y-3">
          {allDocuments.length > 0 ? allDocuments.map((item, idx) => (
            ...
            <div className="py-20 bg-slate-900/20 rounded-[2.5rem] border-2 border-dashed border-white/5 text-center px-10">
               <p className="text-[10px] font-black text-slate-600 uppercase italic">Nenhum arquivo digital disponível.</p>
            </div>
          )}
       </div>

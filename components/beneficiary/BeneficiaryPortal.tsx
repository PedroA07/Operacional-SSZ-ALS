                ...
                <div className="flex items-center gap-4 min-w-0">
                  ...
                  <div className="text-left min-w-0">
                    ...
                    {contract.destination && (
                      <p className="flex items-center gap-1 text-[8px] text-slate-500 font-bold uppercase mt-0.5 truncate group-active:text-blue-100">
                    ...
                    {contract.container && (
                      <p className="flex items-center gap-1 text-[8px] font-mono font-black text-slate-400 mt-0.5 group-active:text-blue-200">
                        <svg className="w-3 h-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">

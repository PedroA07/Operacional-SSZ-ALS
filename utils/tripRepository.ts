...
export const tripRepository = {
  mapToDb: (trip: Trip) => ({
    ...
    retirada_cheio_realizada_em: trip.retiradaCheioRealizadaEm || null,
    retirada_vazio_realizada_em: trip.retiradaVazioRealizadaEm || null,
  ...
  mapFromDb: (d: any): Trip => {
    ...
    return {
      ...
      retiradaCheioRealizadaEm: d.retirada_cheio_realizada_em || undefined,
      retiradaVazioRealizadaEm: d.retirada_vazio_realizada_em || undefined,
